    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]">
                ...
                {isAdmin && (
                    <DropdownMenuItem className="text-red-600 px-3 py-2 text-sm cursor-pointer" onClick={() => onOpen("deleteServer", { server })}>
                        Delete Server
                ...
                {!isAdmin && (
                    <DropdownMenuItem className="text-red-600 px-3 py-2 text-sm cursor-pointer" onClick={() => onOpen("leaveServer", { server })}>
                        Leave Server
